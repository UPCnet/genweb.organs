...
class FunctionalTestCase(unittest.TestCase):
    ...
    def test_allroles_organ_restricted_to_afectats_view_files_as_secretari(self):
    ...
    def test_allroles_organ_restricted_to_afectats_view_files_as_editor(self):
        """Test as OG2-Editor
        """
        logout()
        setRoles(self.portal, TEST_USER_ID, ['OG1-Secretari', 'OG2-Editor', 'OG3-Membre' 'OG4-Afectat'])
    ...
    def test_allroles_organ_restricted_to_afectats_view_files_as_membre(self):
    ...
    def test_allroles_organ_restricted_to_afectats_view_files_as_afectat(self):
        """Test as OG4-Afectat
        """
        logout()
        setRoles(self.portal, TEST_USER_ID, ['OG1-Secretari', 'OG2-Editor', 'OG3-Membre' 'OG4-Afectat'])
