...
class View(grok.View):
    ...
    def showOrdreDiaIAssistencia(self):
        ...
        if review_state in ['planificada', 'convocada'] and roles:
            value = True
        elif self.context.organType == 'open_organ' and review_state == 'convocada' and utils.isConvidat(self):
            value = True
        return value
    ...
    def showPresentacionButton(self):
        ...
        if utils.isManager(self):
            ...
            return True
        elif self.context.organType == 'open_organ' and estatSessio in ['convocada', 'realitzada', 'tancada', 'en_correccio'] and utils.isConvidat(self):
            return True
        else:
            return False
    ...
    def canViewTabActes(self):
        ...
        if organ_tipus == 'open_organ':
            if estatSessio == 'planificada' and (utils.isSecretari(self) or utils.isEditor(self)):
                return True
            elif estatSessio == 'convocada' and (utils.isSecretari(self) or utils.isEditor(self) or utils.isMembre(self) or utils.isConvidat(self)):
                return True
            elif estatSessio == 'realitzada' and (utils.isSecretari(self) or utils.isEditor(self) or utils.isMembre(self) or utils.isConvidat(self)):
                return True
                ...
                return True
            elif estatSessio == 'en_correccio' and (utils.isSecretari(self) or utils.isEditor(self) or utils.isMembre(self) or utils.isConvidat(self)):
                return True
            else:
                return False
        else:
