...
class FunctionalTestCase(unittest.TestCase):
    ...
    def test_organ_restricted_to_membres_view_files_as_secretari(self):
        ...
        print(
            "    ORGAN RESTRINGIT A MEMBRES - [Secretari] - SESSIO EN MODIFICACIO - View")
        # PUNT
    ...
    def test_organ_restricted_to_membres_view_files_as_editor(self):
        ...
        # Check session state CONVOCADA
        self.assertTrue(root_path.membres.convocada.restrictedTraverse('@@view')())
        print("\n    ORGAN RESTRINGIT A MEMBRES - [Editor] - SESSIO CONVOCADA - View")
        # PUNT
        self.assertTrue(DisplayFile(root_path.membres.convocada.punt.public,
                        request).publishTraverse(request, 'visiblefile')())
        print("        PUNT/Fitxer public (camp visible) - DisplayFile - View")
        ...
        self.assertTrue(root_path.membres.correccio.restrictedTraverse('@@view')())
        print(
            "    ORGAN RESTRINGIT A MEMBRES - [Editor] - SESSIO EN MODIFICACIO - View")
        # PUNT
        self.assertTrue(DisplayFile(root_path.membres.correccio.punt.public,
                        request).publishTraverse(request, 'visiblefile')())
        print("        PUNT/Fitxer public (camp visible) - DisplayFile - View")
    ...
    def test_organ_restricted_to_membres_view_files_as_membre(self):
        ...
        # Check session state PLANIFICADA
        self.assertRaises(
            Unauthorized, root_path.membres.planificada.restrictedTraverse('@@view'))
        print(
        ...
        self.assertTrue(root_path.membres.correccio.restrictedTraverse('@@view')())
        print(
            "    ORGAN RESTRINGIT A MEMBRES - [Membre] - SESSIO EN MODIFICACIO - View")
        # PUNT
        self.assertTrue(DisplayFile(root_path.membres.correccio.punt.public,
                        request).publishTraverse(request, 'visiblefile')())
        print("        PUNT/Fitxer public (camp visible) - DisplayFile - View")
    ...
    def test_organ_restricted_to_membres_view_files_as_afectat(self):
        ...
        print(
            "    ORGAN RESTRINGIT A MEMBRES - [Afectat] - SESSIO CONVOCADA - Unauthorized")
        self.assertRaises(Unauthorized, DisplayFile(
        ...
        print(
            "    ORGAN RESTRINGIT A MEMBRES - [Afectat] - SESSIO REALITZADA  - Unauthorized")
        self.assertRaises(Unauthorized, DisplayFile(
        ...
        print(
            "    ORGAN RESTRINGIT A MEMBRES - [Afectat] - SESSIO TANCADA - Unauthorized")
        self.assertRaises(Unauthorized, DisplayFile(
        ...
        print(
            "    ORGAN RESTRINGIT A MEMBRES - [Afectat] - SESSIO EN MODIFICACIO - Unauthorized")
        self.assertRaises(Unauthorized, DisplayFile(
    ...
    def test_organ_restricted_to_membres_view_files_as_anonim(self):
        ...
        self.assertRaises(
            Unauthorized, root_path.membres.convocada.restrictedTraverse('@@view'))
        print(
            "    ORGAN RESTRINGIT A MEMBRES - [Anonim] - SESSIO CONVOCADA - Unauthorized")
        self.assertRaises(Unauthorized, DisplayFile(
            root_path.membres.convocada.punt.public, request).publishTraverse(request, 'visiblefile'))
        print("        PUNT/Fitxer public (camp visible) - DisplayFile - Unauthorized")
        self.assertRaises(
        ...
        self.assertRaises(
            Unauthorized, root_path.membres.realitzada.restrictedTraverse('@@view'))
        print(
            "    ORGAN RESTRINGIT A MEMBRES - [Anonim] - SESSIO REALITZADA  - Unauthorized")
        self.assertRaises(Unauthorized, DisplayFile(
            root_path.membres.realitzada.punt.public, request).publishTraverse(request, 'visiblefile'))
        print("        PUNT/Fitxer public (camp visible) - DisplayFile - Unauthorized")
        self.assertRaises(Unauthorized, Download(
        ...
        self.assertRaises(
            Unauthorized, root_path.membres.tancada.restrictedTraverse('@@view'))
        print(
            "    ORGAN RESTRINGIT A MEMBRES - [Anonim] - SESSIO TANCADA - Unauthorized")
        self.assertRaises(Unauthorized, DisplayFile(
            root_path.membres.tancada.punt.public, request).publishTraverse(request, 'visiblefile'))
        print("        PUNT/Fitxer public (camp visible) - DisplayFile - Unauthorized")
        self.assertRaises(
        ...
        self.assertRaises(
            Unauthorized, root_path.membres.correccio.restrictedTraverse('@@view'))
        print(
            "    ORGAN RESTRINGIT A MEMBRES - [Anonim] - SESSIO EN MODIFICACIO - Unauthorized")
        self.assertRaises(Unauthorized, DisplayFile(
            root_path.membres.correccio.punt.public, request).publishTraverse(request, 'visiblefile'))
        print("        PUNT/Fitxer public (camp visible) - DisplayFile - Unauthorized")
        self.assertRaises(
